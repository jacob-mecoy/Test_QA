...
public class Test_1 extends Base_Test{
    ...
    private void Test_1_a(){
        ...
        //Below we use an assertion assertThat. This comes from the Hamcrest library.
        //We also use Matchers from the Hamcrest library. We use these to improve code readability and compare items.
